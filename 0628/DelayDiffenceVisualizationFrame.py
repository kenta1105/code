...
class DelayDiffenceVisualizationFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.read_RAM_result_label.grid(row=0, column=1, sticky=ctk.NSEW)
        ...
        self.graph_draw_frame.grid_columnconfigure(index=5, weight=1)
        self.graph_draw_frame.grid_columnconfigure(index=6, weight=1)
        self.graph_draw_frame.grid_columnconfigure(index=7, weight=1)
        self.graph_draw_frame.grid_columnconfigure(index=8, weight=1)
        ...
        self.car_label.grid(row=0, column=0, sticky=ctk.NSEW)
        ...
        self.car_stationary_radiobutton.grid(row=1, column=0, sticky=ctk.NSEW)
        ...
        self.car_move_radiobutton.grid(row=2, column=0, sticky=ctk.NSEW)     
        ...
        self.dummy_label.grid(row=0, column=2, columnspan=1, sticky=ctk.NSEW)
        ...
        self.dummy_stationary_radiobutton.grid(row=1, column=1, sticky=ctk.NSEW)
        ...
        self.dummy_move_radiobutton.grid(row=2, column=1, sticky=ctk.NSEW)    

        # ダミー種類
        self.dummy_type_radio_var = ctk.IntVar(value=1)
        # 大人
        self.dummy_adult_radiobutton = ctk.CTkRadioButton(
            self.graph_draw_frame, 
            text="大人",
            command=None, 
            variable=self.dummy_type_radio_var, 
            value=1,
            **RADIOBUTTON_PARMAS
        )
        self.dummy_adult_radiobutton.grid(row=1, column=2, sticky=ctk.NSEW)
        
        # 子供
        self.dummy_child_radiobutton = ctk.CTkRadioButton(
            self.graph_draw_frame, 
            text="子供",
            command=None, 
            variable=self.dummy_type_radio_var, 
        ...
        self.dummy_child_radiobutton.grid(row=2, column=2, sticky=ctk.NSEW)
        
        # ダミーの初期位置
        self.dummy_position_label = ctk.CTkLabel(
            master=self.graph_draw_frame,
            text="ダミーの\n初期位置[cm]",
            **LABEL_PARAMS 
        )
        self.dummy_position_label.grid(row=0, column=3, columnspan=2, sticky=ctk.NSEW)
        
        # 縦
        self.dummy_LNG_position_label = ctk.CTkLabel(
            master=self.graph_draw_frame,
            text="縦",
            **LABEL_PARAMS 
        )
        self.dummy_LNG_position_label.grid(row=1, column=3, sticky=ctk.NSEW)

        self.dummy_LNG_position_var = ctk.StringVar(value="0")
        self.dummy_LNG_position_entry = ctk.CTkEntry(
            master=self.graph_draw_frame,
            textvariable=self.dummy_LNG_position_var, 
            placeholder_text = "縦",
            **ENTRY_PARAMS
        )
        self.dummy_LNG_position_entry.grid(row=1, column=4, sticky=ctk.NSEW)

        # 横
        self.dummy_LAT_position_label = ctk.CTkLabel(
            master=self.graph_draw_frame,
            text="横",
            **LABEL_PARAMS 
        )
        self.dummy_LAT_position_label.grid(row=2, column=3, sticky=ctk.NSEW)

        self.dummy_LAT_position_var = ctk.StringVar(value="0")
        self.dummy_LAT_position_entry = ctk.CTkEntry(
            master=self.graph_draw_frame,
            textvariable=self.dummy_LAT_position_var, 
            placeholder_text = "横",
            **ENTRY_PARAMS
        )
        self.dummy_LAT_position_entry.grid(row=2, column=4, sticky=ctk.NSEW)
        ...
        self.head_label.grid(row=0, column=5, sticky=ctk.NSEW)          
        ...
        self.head_entry = ctk.CTkEntry(
            ...
            **ENTRY_PARAMS)
        self.head_entry.grid(row=1, column=5, sticky=ctk.NSEW)
        ...
        self.head_use_switch.grid(row=2, column=5, sticky=ctk.NSEW)
        ...
        self.initial_shift_label.grid(row=0, column=6, sticky=ctk.NSEW)   
        ...
        self.initial_shift_entry = ctk.CTkEntry(
            ...
            **ENTRY_PARAMS)
        self.initial_shift_entry.grid(row=1, rowspan=2, column=6, sticky=ctk.NSEW)   
        ...
        self.compare_label.grid(row=0, column=7, columnspan=2, sticky=ctk.NSEW)
        
        # ラジオボタン
        self.compare_radio_var = ctk.IntVar(value=1)
        # Vbox
        self.vbox_compare_radiobutton = ctk.CTkRadioButton(
            self.graph_draw_frame, 
            text="Vbox",
            command=None, 
            variable=self.compare_radio_var, 
            value=1,
            **RADIOBUTTON_PARMAS
        )
        self.vbox_compare_radiobutton.grid(row=1, column=7, sticky=ctk.NSEW)
        
        # 画像
        self.image_compare_radiobutton = ctk.CTkRadioButton(
            self.graph_draw_frame, 
            text="画像",
            command=None, 
            variable=self.compare_radio_var, 
        ...
        self.image_compare_radiobutton.grid(row=2, column=7, sticky=ctk.NSEW)   

        # 画像(縦のみ)
        self.image_lng_compare_radiobutton = ctk.CTkRadioButton(
            self.graph_draw_frame, 
            text="画像-縦",
            command=None, 
            variable=self.compare_radio_var, 
        ...
        self.image_lng_compare_radiobutton.grid(row=1, column=8, sticky=ctk.NSEW)   

        # 画像(横のみ)
        self.image_lat_compare_radiobutton = ctk.CTkRadioButton(
            self.graph_draw_frame, 
            text="画像-横",
            command=None, 
            variable=self.compare_radio_var, 
        ...
        self.image_lat_compare_radiobutton.grid(row=2, column=8, sticky=ctk.NSEW)     
        ...
        self.smoothing_slider = ctk.CTkSlider(
            ...
            command=lambda x:self.graph_display_frame.updateGraphBySlider(
                slider_var         = self.smoothing_slider_var,
                slider_value_label = self.smoothing_value_label,
                update_type        = GraphUpdateType.SMOOTHING,
                dummy_type         = self.dummy_type_radio_var.get(),
                car_action         = self.car_radio_var.get(),
                dummy_action       = self.dummy_radio_var.get(),
                dummy_pos_LNG      = self.dummy_LNG_position_entry.get(),
                dummy_pos_LAT      = self.dummy_LAT_position_entry.get()
            )
        )
        ...
        self.smoothing_dwon_button = ctk.CTkButton(
            ...
            text="Down\nMin:3000[ms]",
            **BUTTON_PARAMS,
            command=lambda:self.graph_display_frame.updateGraphByButton(
                widget_type        = WidgetType.MINUS_BUTTON,  
                slider_var         = self.smoothing_slider_var,  
                slider_value_label = self.smoothing_value_label,
                update_type        = GraphUpdateType.SMOOTHING,
                value_min          = 0,
        ...
        self.smoothing_up_button = ctk.CTkButton(
            ...
            **BUTTON_PARAMS,
            command=lambda:self.graph_display_frame.updateGraphByButton( 
                widget_type        = WidgetType.PLUS_BUTTON, 
                slider_var         = self.smoothing_slider_var,  
                slider_value_label = self.smoothing_value_label,
                update_type        = GraphUpdateType.SMOOTHING,
                value_min          = 0,
        ...
        self.shift_slider = ctk.CTkSlider(
            ...
            command=lambda x:self.graph_display_frame.updateGraphBySlider(
                slider_var         = self.shift_slider_var,
                slider_value_label = self.shift_value_label,
                update_type        = GraphUpdateType.SHIFT,
                dummy_type         = self.dummy_type_radio_var.get(),
                car_action         = self.car_radio_var.get(),
                dummy_action       = self.dummy_radio_var.get(),
                dummy_pos_LNG      = self.dummy_LNG_position_entry.get(),
        ...
        self.graph_draw_label.grid(row=1, column=4, sticky=ctk.NSEW)
        ...
        self.graph_draw_button.grid(row=0, column=4, sticky=ctk.NSEW)
        ...
        # 真値を描画するボタン
        # ---------------------------------------------------------- #   
        self.plot_ground_truth_button = ctk.CTkButton(
            self.RAM_frame, 
            text="真値と比較",
            **BUTTON_PARAMS,
            command=lambda:self.graph_display_frame.plotGroundTruth(
                compare      = self.compare_radio_var.get(),
                output_label = self.read_RAM_result_label                
            )
        )
        self.plot_ground_truth_button.grid(row=0, column=2, sticky=ctk.NSEW)
